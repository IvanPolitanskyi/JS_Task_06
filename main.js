...
//создать функции конструкторы которые создают объекты с нужными параметрами 
//и определяют методы которые вычисляют:

//1) площадь круга
//2) длину окружности
//3) среднее арифметическое двух чисел
//4) среднее арифметическое массива (числа)

//Например:

//let circle = new Circle(10);
//console.log(circle.calculateSquare()) // 314.15
